...
const ExternalRequestsManagement = () => {
  ...
  const handleApproveRequest = (requestId) => {
    setExternalRequests(prev => prev.map(req => 
  ...
  if (!isBloodDepartment) {
    return (
      <div className="external-requests-management">
        <DoctorSidebar />
    ...
    <div className="external-requests-management">
      ...
      <div className="external-requests-content">
        <div className="page-header">
          <div>
            <h1>🌐 Yêu cầu Máu Bên ngoài</h1>
            <p>Xem và duyệt yêu cầu máu từ cá nhân và bệnh viện bên ngoài</p>
            <div className="blood-dept-notice">
              🩸 Khoa Huyết học - Quyền duyệt yêu cầu bên ngoài
            </div>
          </div>
        </div>
        ...
        <div className="requests-section">
          ...
          <div className="requests-grid">
            {filteredRequests.map(request => (
              <div key={request.requestID} className={`request-card ${getStatusColor(request.status)}`}>
                <div className="card-header">
                  ...
                  <div className="request-badges">
                    ...
                    {request.isRare && <span className="rare-badge">⭐ Máu hiếm</span>}
                  </div>
                </div>
                ...
                <div className="card-body">
                  ...
                  <div className="request-details">
                    ...
                    <div className="doctor-info">
                      BS. {request.doctorInfo.name} - {request.doctorInfo.department}
                    </div>
                  </div>
                </div>
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <div className="detail-section">
                ...
                <div className="detail-row">
                  <strong>Loại:</strong> {getRequesterTypeText(selectedRequest.requesterType)}
                </div>
                <div className="detail-row">
                  <strong>Điện thoại:</strong> {selectedRequest.contactInfo.phone}
                </div>
                <div className="detail-row">
                  <strong>Email:</strong> {selectedRequest.contactInfo.email}
                </div>
                <div className="detail-row">
                  <strong>Địa chỉ:</strong> {selectedRequest.contactInfo.address}
                </div>
              </div>
              ...
              <div className="detail-section">
                ...
                <div className="detail-row">
                  <strong>Bệnh viện:</strong> {selectedRequest.doctorInfo.hospital}
                </div>
                <div className="detail-row">
                  <strong>Điện thoại:</strong> {selectedRequest.doctorInfo.phone}
                </div>
              </div>
              ...
              <div className="detail-section">
                ...
                <div className="detail-row">
                  ...
                  {selectedRequest.isRare && <span className="rare-badge">⭐ Máu hiếm</span>}
                </div>
                <div className="detail-row">
                ...
                <div className="detail-row">
                  ...
                  <span className={`urgency-badge urgency-${getUrgencyColor(selectedRequest.urgencyLevel)}`}>
              ...
              {selectedRequest.medicalDocuments && selectedRequest.medicalDocuments.length > 0 && (
                <div className="detail-section">
                  <h3>Tài liệu y tế</h3>
