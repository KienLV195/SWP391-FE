...
const BloodDonationFormPage = () => {
  ...
  useEffect(() => {
    ...
    const combinedInfo = {
      ...
      documentNumber:
        userProfile.documentNumber || localInfo.documentNumber || "",
      ...
      <div className="step-header">
        ...
        <div className="header-content">
          ...
          <p className="step-subtitle">
            Vui lòng kiểm tra kỹ thông tin cá nhân trước khi tiếp tục. Nếu có
            sai sót, hãy chỉnh sửa tại đây.
          </p>
        </div>
      </div>
  ...
  const renderQuestionnairePage1 = () => (
    <div className="donation-form-step questionnaire-step">
          ...
          <div className="radio-group">
            <label>
              <input
                ...
                onChange={(e) =>
                  updateQuestionnaireAnswer("q1", e.target.value)
                }
              />{" "}
              Có
            </label>
          ...
          <div className="radio-group">
            <label>
              <input
                ...
                onChange={(e) =>
                  updateQuestionnaireAnswer("q2", e.target.value)
                }
              />{" "}
              Có
            </label>
          ...
          {questionnaireAnswers.q2 === "yes" && (
            <div className="question-detail">
              ...
              <input
                ...
                onChange={(e) =>
                  updateQuestionnaireAnswer("q2_detail", e.target.value)
                }
              />
            </div>
          )}
      ...
      <div className="question-block">
        <div className="question-header">
          3. Anh/chị đã từng mắc một trong các bệnh sau đây trước đây chưa:
        </div>
        <div className="question-subtext">
          viêm gan B, viêm gan C, HIV, vảy nến, phì đại tiền liệt tuyến, sốc
          phản vệ, tai biến mạch máu não, nhồi máu cơ tim, lupus ban đỏ, động
          kinh, ung thư, hen suyễn, hoặc đã từng được cấy ghép mô/tạng?
        </div>
        <div className="question-body">
          <div className="radio-group">
            <label>
              <input
                ...
                onChange={(e) =>
                  updateQuestionnaireAnswer("q3", e.target.value)
                }
              />{" "}
              Có
            </label>
              ...
              <div className="radio-group">
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestionnaireAnswer("q4a", e.target.value)
                    }
                  />{" "}
                  Có
                </label>
              ...
              <div className="radio-group">
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestionnaireAnswer("q4b", e.target.value)
                    }
                  />{" "}
                  Có
                </label>
              ...
              <div className="radio-group">
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestionnaireAnswer("q4c", e.target.value)
                    }
                  />{" "}
                  Có
                </label>
          ...
          <div className="sub-questions">
            <div className="sub-question">
              <span>
                ...
                trùng máu, bị rắn cắn, viêm tắc động mạch, viêm tắc tĩnh mạch,
                viêm tụy, viêm tủy xương?
              </span>
              <div className="radio-group">
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestionnaireAnswer("q5a", e.target.value)
                    }
                  />{" "}
                  Có
                </label>
              ...
              <div className="radio-group">
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestionnaireAnswer("q5b", e.target.value)
                    }
                  />{" "}
                  Có
                </label>
              ...
              <div className="radio-group">
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestionnaireAnswer("q5c", e.target.value)
                    }
                  />{" "}
                  Có
                </label>
            ...
            <div className="sub-question">
              <span>
                Thực hiện thủ thuật y tế xâm lấn (chữa răng, châm cứu, lăn kim,
                nội soi,…)?
              </span>
              <div className="radio-group">
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestionnaireAnswer("q5d", e.target.value)
                    }
                  />{" "}
                  Có
                </label>
              ...
              <div className="radio-group">
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestionnaireAnswer("q5e", e.target.value)
                    }
                  />{" "}
                  Có
                </label>
    ...
    <div className="donation-form-step questionnaire-step">
              ...
              <div className="radio-group">
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestionnaireAnswer("q6a", e.target.value)
                    }
                  />{" "}
                  Có
                </label>
              ...
              <div className="radio-group">
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestionnaireAnswer("q6b", e.target.value)
                    }
                  />{" "}
                  Có
                </label>
              ...
              <div className="radio-group">
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestionnaireAnswer("q7a", e.target.value)
                    }
                  />{" "}
                  Có
                </label>
              ...
              <div className="radio-group">
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestionnaireAnswer("q8a", e.target.value)
                    }
                  />{" "}
                  Có
                </label>
              ...
              <div className="radio-group">
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestionnaireAnswer("q9a", e.target.value)
                    }
                  />{" "}
                  Có
                </label>
              ...
              <div className="radio-group">
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestionnaireAnswer("q9b", e.target.value)
                    }
                  />{" "}
                  Có
                </label>
      ...
      {showSuccess && (
        <div className="success-notification">
          ...
          ĐÃ NHẬN ĐƯỢC ĐƠN ĐĂNG KÝ CỦA BẠN, THEO DÕI THANH THÔNG BÁO Ở TRANG CHỦ
