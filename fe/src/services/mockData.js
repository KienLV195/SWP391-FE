...
export const MOCK_BLOGS = [
  // Doctor posts - Tài liệu (auto-published)
  {
    ...
    excerpt:
      "Hướng dẫn chi tiết các bước chuẩn bị cần thiết trước khi hiến máu để đảm bảo an toàn và hiệu quả.",
  ...
  },
  {
    ...
    targetAudience: "public",
    excerpt:
      "Kiến thức cơ bản về hệ nhóm máu ABO, Rh và tính tương thích trong truyền máu.",
  ...
  },
  {
    ...
    targetAudience: "public",
    excerpt:
      "Quy trình xét nghiệm máu hiến tặng để đảm bảo an toàn cho người nhận.",
  ...
  // Manager posts - Tin tức (auto-published)
  {
    ...
    targetAudience: "public",
    excerpt:
      'Bệnh viện Ánh Dương tổ chức chiến dịch hiến máu nhân đạo "Giọt máu hồng - Tình người ấm" trong tháng 2/2024.',
  ...
  // Manager posts - Thông báo nội bộ (internal)
  {
    ...
    excerpt:
      "Thông báo lịch trực và phân công công việc cho khoa Huyết học trong tháng 2/2024.",
